...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |bomberman copy 2|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require racket/base)
(require 2htdp/image)
